...
'add 3rd party FIX THIS
add_product_option "HA842A1"
...
Sub add_product_option(strName)
	...
	Browser("name:=Home.*").Page("title:=Home.*").WebEdit("xpath:=//option[@label='Product']/parent::select/parent::div/parent::div/following-sibling::div[1]//input").Set strName
	Browser("name:=Home.*").Page("title:=Home.*").WebEdit("xpath:=//option[@label='Product']/parent::select/parent::div/parent::div/following-sibling::div[1]//input").Click
	Browser("name:=Home.*").Page("title:=Home.*").WebEdit("xpath:=//option[@label='Product']/parent::select/parent::div/parent::div/following-sibling::div[1]//input").SendKeys "~"
End Sub
